...
function toExponential(number, fractionDigits) {
  const string = Number.parseFloat(number).toExponential(fractionDigits);
  return string;
}
...
function toFixed(number, fractionDigits) {
  const string = number.toFixed(fractionDigits);
  return string;
}
...
function toPrecision(number, precision) {
  const string = number.toPrecision(precision);
  return string;
}
...
function getIntegerOnString(str, base) {
  const integer = Number.parseInt(str, base);
  return integer;
}
...
function roundToLargestInteger(number) {
  const integer = Math.ceil(number);
  return integer;
}
...
function getSumOfNumbers(x1, x2, x3) {
  const sum = Number((x1 + x2 + x3).toFixed(2));
  return sum;
}
...
function getCountOfOddNumbers(number) {
  const count = Math.ceil(Math.abs(number) / 2);
  return count;
}
